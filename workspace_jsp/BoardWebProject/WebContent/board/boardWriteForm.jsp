...
<div id="container">
	...
	<form action="boardWritePro.jsp" method="post" name="writeForm">
		...
		<table>
			<tr>
				<th width="15%">작성자</th>
				<td width="85%"><span class="c_id"><input type="text" name="writer" id="writer" value="<%=memberId %>" size="20"></span></td>
			</tr>
			<tr>
				<th>제목</th>
				<td class="c_text"><input type="text" name="subject" id="subject" size="54"></td>
			</tr>
			<tr>
				<th>내용</th>
				<td><textarea rows="22" cols="56" name="content"></textarea></td>
			</tr>
		</table>
		<div class="btns">
