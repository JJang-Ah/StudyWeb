...
.s3_c1 span { display: inline-block; width: 120px; height: 30px; padding: 10px; margin: 0 20px; border: 2px solid #32708d;
...
.s3_review .s3_r1 { width: 75%; float: left; border: 1px solid #f1f3f5; padding: 20px; background: #f8f9fa; margin-right: 20px;}
...
// 개인 쇼핑몰에서 이미지가 5장이고, 1번만 not null이고, 나머지는 nothint.jpg가 저장되어 있다고 가정할 때 1번의 이미지로 변경하여 보여주는 방법
/*
...
<div class="container">
	...
	<div class="detail">
		...
		<form action="../cart/cartInsertPro.jsp" method="post" name="contentForm">
			...
			<%-- cartList.jsp(장바구니)로 이동: cart_id, buy_count를 제외한 9가지 필드 정보 --%>
