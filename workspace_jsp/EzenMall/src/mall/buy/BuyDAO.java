...
public class BuyDAO {
	...
	// 구매목록 추가 - 트랜잭션 처리
	// 3가지의 작업 - 구매 테이블에 구매상품을 등록, 카트 테이블에서 구매상품을 삭제, 상품 테이블에서 상품의 재고량을 수정
	public void insertBuyList(List<BuyDTO> buyList, List<CartDTO> cartList) throws SQLException {
		...
		try { 
			...
			// 3번 작업 - 상품 테이블에서 구매 상품의 재고량을 파악 -> 상품 테이블에서 상품의 재고량을 수정(구매 상품의 개수를 빼서 설정)
			for(BuyDTO buy : buyList) {
