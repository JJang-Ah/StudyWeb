...
<div class="container">
	...
	<div class="paging">
		...
		<c:if test="${pageDTO.prev }">
			<c:set var="" value="${pageDTO.startPage-1 }"/>
			<a href="getBoardList.do?pageNum=" class="p_box"></a>
		</c:if>
		<!-- 페이지 번호 -->
		<c:forEach var="num" varStatus="s" begin="${pageDTO.startPage}" end="${page.endPage }">
		...
		<c:if test="${pageDTO.next }">
			<a href="${pageDTO.endPage+1 }" class="p_box"></a>
		</c:if>
